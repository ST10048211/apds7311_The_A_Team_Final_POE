...
const Payment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //Code adapted from: https://reactnavigation.org/docs/params
  ...
  return (
    <div className="acc-payment-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Submit Button */}
        <button type="payment-button">Pay Now</button>
        {/* Logout Button */}
        <button className="payment-back-button" onClick={handleLogout}>Back to Home</button>
      </form>
    </div>
  );
};
